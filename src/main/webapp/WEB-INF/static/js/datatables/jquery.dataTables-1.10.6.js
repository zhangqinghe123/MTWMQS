...
/*		//var input = '<div class="input-group"><input type="search" class="form-control"/>' +
		...
		'</div>'+
		'<div class="form-group">'+
		'<span id="btnSearch'+tableId+'" class="btn btn-secondary btn-single">搜索</span>'+
		'</div>'+
	'';
		...
		var filter = $('<div/>', {
			...
			.append( $('<form class="form-inline"/>' ).append( str ) );
		...
		var searchFn = function() {
			...
			if (val != previousSearch.sSearch) {
				...
				//触发搜索
				//_fnDraw( settings );
				$('#btnSearch'+tableId).off().on('click',function(){
					_fnDraw( settings );
				});
			}
		};
