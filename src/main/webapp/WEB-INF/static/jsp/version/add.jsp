        ...
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" id="versionForm" modelAttribute="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" name="versionName" data-rule-required="true" placeholder="请输入版本名称"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" name="versionCode" data-rule-required="true" placeholder="请输入版本号"/>
                    </div>
                </div>
                <div class="space-4"></div>
                <div class="form-group">
