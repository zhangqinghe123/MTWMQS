...
public class StStbprpBController {
    ...
    private final StStbprpBService stStbprpBService;

    public StStbprpBController(StStbprpBService stStbprpBService) {
        this.stStbprpBService = stStbprpBService;
    }
    ...
    public AjaxList getRainSiteInfo() {
        stStbprpBService.getAll();
        return AjaxList.createSuccess("检查成功", null);
    }
