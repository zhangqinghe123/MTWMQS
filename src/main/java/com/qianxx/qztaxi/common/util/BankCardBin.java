...
public class BankCardBin {  
    ...
    private static final String[] bankName = { "广东发展银行.广发理财通", "农业银行.金穗借记卡",  
            ...
            "上海浦东发展银行.东方卡", "深圳发展银行.发展卡","建设银行-借记卡.龙卡通", "招商银行","工商银行.牡丹卡普卡",};  
    ...
    public static void main(String[] args) {  
        String cardNumber = "6217001930001953299";// 卡号  
        ...
        String name = BankCardBin.getNameOfBank(cardNumber.substring(0, 6));// 获取银行卡的信息  
