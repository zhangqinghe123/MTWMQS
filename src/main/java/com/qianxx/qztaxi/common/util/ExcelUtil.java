...
public class ExcelUtil<T> {
     ...
     */
    public void exportExcel(List<T> list, String sheetName, int sheetSize, HttpServletResponse response) {
        ...
        try {
			...
			// 进行转码，使其支持中文文件名
			sheetName = java.net.URLEncoder.encode(sheetName + DateUtil.TimeToForDay(DateUtil.getSystemTime()), "UTF-8");
